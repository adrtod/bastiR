...
if (inputenc == "utf8")
  ...
  cat("\\DeclareUnicodeCharacter{0301}{\\'} % pour accent aigü en utf8\n")
  cat("\\DeclareUnicodeCharacter{00B0}{\\textdegree{}} % pour degré en utf8\n")
@
...
\vspace*{\Sexpr{vspace}}
{\Large \color{red} \Sexpr{garde$reu_next} \\} % prochaine réunion
\vspace*{\Sexpr{vspace}}
