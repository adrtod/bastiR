...
\title{CONSTRUCTION D'UN FAS ET FATH PASSIF AU BEUBOIS A ORBEY}
\author{\href{mailto:t.weulersse@atelier-d-form.com}{t.weulersse@atelier-d-form.com}}
\date{Compte rendu \no 12 de la réunion du 22 Avril 2015}
...
\begin{center}
\textcolor{red}{Réunion de chantier \no 13 à \textbf{9H00} le mercredi 29 avril 2015}
\end{center}
